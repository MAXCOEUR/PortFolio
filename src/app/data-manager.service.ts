    ...
    this.projects = [
      new ProjectModel("BillAR","Le projet billA.R, est un système d'assistance pour le célèbre jeu du billard. Il permet la détection des billes et"+
        " des queues, afin de créer et d'afficher la trajectoire pour aider le joueur à réaliser son coup.",
         ...
         [
          ...
          new UrlWithLabel("Download","https://github.com/MAXCOEUR/sae_billard/releases/latest"),
        ],
        [
          ...
          new ImageWithDescription("assets/project/BillAR/5.jpeg", "ce projet a été realiser dans le cadre de l'iut avec un tuteur monsieur Telez. les technologie utilisé sont python yolo et opencv."),
        ]),
      new ProjectModel("Pouic","Pouic est une application de type réseau social qui permet aux utilisateurs d'échanger des messages privés, de publier "+
        "des posts similaires à ceux de Twitter et de partager des images quotidiennes, à l'instar de BeReal.",
         ...
         [
          ...
          new UrlWithLabel("Download","https://github.com/MAXCOEUR/discution_app/releases/latest"),
          new UrlWithLabel("regles confidentialit","https://pouic-web-regles-confidentialit.vercel.app/"),
        ],
        [
          ...
          new ImageWithDescription("assets/project/Pouic/4.jpeg", "Où Trouver Pouic ? Vous pouvez télécharger Pouic sur Android dès maintenant sur GitHub : https://github.com/MAXCOEUR/discution_app/releases/latest . 📲"),
        ]),
      ...
      new ProjectModel("Dj Application","Création d’une application de mixage pour D.J. avec Youtube Music + Interaction avec une table de mixage réel",
        ...
        [
          ...
          new UrlWithLabel("Download","https://github.com/MAXCOEUR/DjApplication3/releases/latest")
        ],
        [
          ...
          new ImageWithDescription("assets/project/Dj Application/4.png","C'est une aventure personnelle qui a pris forme, et je suis ravi de la partager avec vous tous. Téléchargez DjApplication dès maintenant pour redéfinir votre expérience musicale! 🎵📲https://github.com/MAXCOEUR/DjApplication3/releases/latest "),
        ]),
