    ...
    this.projects = [
      ...
      new ProjectModel("Pouic","Pouic est une application de type réseau social qui permet aux utilisateurs d'échanger des messages privés, de publier "+
        ...
        [
          ...
          new ImageWithDescription("assets/project/Pouic/4.jpeg", "Où Trouver Pouic ? Vous pouvez télécharger Pouic sur Android dès maintenant avefc le bouton dessus 'Téléchargement'. 📲"),
